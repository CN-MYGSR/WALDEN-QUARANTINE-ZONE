...
// 全封闭室内设施: 地面是整浇混凝土底板, 完全水平 —— 任何起伏都会在
// 房间地板与走廊之间露出缝隙, 因此这里直接返回 0。
case 'flat':
return 0;
...
case 'taiga':{
// 针叶雪原: 缓丘起伏, 沼泽洼地, 低幅度
const r1=1-Math.abs(Math.sin(x*0.017+z*0.013));
const r2=1-Math.abs(Math.sin(z*0.02-x*0.011+1.2));
return r1*r1*2.6+r2*r2*1.9+0.5*Math.sin(x*0.03+1)*Math.cos(z*0.028+0.7)-1.3;
}
default:
