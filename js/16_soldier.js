...
// 现代复合头盔(ACH/Kevlar): 圆顶+盔沿+导轨+夜视支架
helm=new THREE.Mesh(new THREE.SphereGeometry(0.152,10,8,0,TAU,0,HPI*1.32),U.helm);
helm.position.set(0,0.158,0); helm.scale.z=1.08;
headG.add(hAdd(helm));
headG.add(hAdd(bx(U.helm,0.15,0.03,0.05, 0,0.118,0.155)));
headG.add(hAdd(bx(new THREE.MeshLambertMaterial({color:0x8a8e8a}),0.018,0.02,0.05, 0,0.185,0)));
headG.add(hAdd(bx(new THREE.MeshLambertMaterial({color:0x3a3e3a}),0.012,0.016,0.012, 0.0,0.2,0.14)));
} else {
// 八路军帽: 布帽+短帽檐(朝前)+红星
